...
return [
    ...
    'http'  => [
        ...
        'session'   => [
            ...
            //使用中间键处理
            'middleware'=> [
                'get'   => \Inphp\Middleware\Session::class,
                'set'   => \Inphp\Middleware\Session::class,
                'remove'  => \Inphp\Middleware\Session::class
            ]
        ]
    ],
    //swoole websocket 配置
    ...
    'cache'    => [
        ...
        'middleware'=> [
            //获取
            'get'   => \Inphp\Middleware\Cache::class,
            //设置
            'set'   => \Inphp\Middleware\Cache::class,
            //移除
            'remove'=> \Inphp\Middleware\Cache::class,
            //清除所有
            'clean' => \Inphp\Middleware\Cache::class
        ]
    ]
];